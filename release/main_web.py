...
def start_web_server(args):
    ...
    # 启动服务器
    auto_monitor = not args.dev  # 开发模式下禁用自动监控
    success = server.start(auto_monitor=auto_monitor)
...
def wait_for_server(server, args):
    ...
    if args.dev:
        ...
        print("\n💡 使用提示:")
        print("   • 关闭浏览器标签页后服务器将自动停止")
        print("   • 或按 Ctrl+C 手动停止服务器")
        print("   • 服务器会智能监控浏览器活动")
